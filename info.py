...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5342963115').split()]
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'YYlttp') # owner username without @
